...
<script type="text/javascript">
    ...
    let _go = () => {
        ...
        location = "${requestScope.pageBean.url}&pageNow=" + pc;
    };
</script>
...
<div class="divBody">
    <div class="divContent">
        <c:choose>
            ...
            <c:otherwise>
                <a href="${requestScope.pageBean.url}&pageNow=${requestScope.pageBean.pageNow-1}"
        ...
        <c:forEach var="index" begin="${begin}" end="${end}" step="1">
            <c:choose>
                <c:when test="${index != requestScope.pageBean.pageNow}">
                    <a href="${requestScope.pageBean.url}&pageNow=${index}"
                       class="aBtn">${index}</a>
                </c:when>
                <c:otherwise>
