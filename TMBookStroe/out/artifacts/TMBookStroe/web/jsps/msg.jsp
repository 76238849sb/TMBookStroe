...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 50px;"><a target="_top" href="${pageContext.request.contextPath}/web/jsps/user/login.jsp">登录</a></span>
		<span style="margin-left: 50px;"><a target="_top" href="${pageContext.request.contextPath}/web/index.jsp">主页</a></span>
	  </div>
	</div>
</div>
