...
<style type="text/css">
  ...
  <body>
    ...
    <form action="${pageContext.request.contextPath}/web/categoryServlet" method="post" onsubmit="return checkForm()">
    	<input type="hidden" name="method" value="updateOneCategory"/>
		<input type="hidden" name="cid" value="${requestScope.cid}"/>
    	分类名称：<input type="text" name="cname" id="cname" value="${requestScope.cname}"/><br/>
    	分类描述：<textarea rows="5" cols="50" id="desc" name="desc">${requestScope.desc}</textarea><br/>
